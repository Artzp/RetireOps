...
> **Status**: Target specification — this document defines the aspirational scope and engineering requirements for the RetireOps source-available Canadian retirement planning system, with delayed open-source licensing planned through BUSL-1.1 change dates.
